...
SHOWCASE = [
    ...
    },
    {
        ...
        'summary': 'Готовый внешний пример из репозитория plague40404/primeri. В рабочем окружении ссылка может вести на поддомен primeri.proforin.online.',
        'accent': '#c8764a',
        'soft': '#f7e6d8',
        'dark': '#2d221d',
        'image': 'landing/img/example-primeri.png',
        'services': ['Меню', 'Промо', 'Атмосфера', 'CTA'],
        'metrics': ['живой пример', 'GitHub Pages', 'готов к поддомену'],
    ...
    },
    {
        ...
        'summary': 'Готовый внешний пример из репозитория plague40404/primeri-2.0. В рабочем окружении ссылка может вести на поддомен primeri-2.proforin.online.',
        'accent': '#9c70ff',
        'soft': '#efe6ff',
        'dark': '#241f33',
