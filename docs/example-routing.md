...
EXAMPLE_PRIMERI_3_URL=/examples/primeri-3/
```
...
| `/examples/primeri-3/` | `examples/primeri3.0.1/` | `https://github.com/plague40404/primeri3.0.1` |
...
location /examples/primeri-3/ {
    alias /srv/kliko-site/current/examples/primeri3.0.1/;
    try_files $uri $uri/ /examples/primeri-3/index.html;
}
```
...
- `https://proforin.online/examples/primeri-3/`
